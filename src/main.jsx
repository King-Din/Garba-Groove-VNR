...
function App(){
 ...
 return <div className="app">
  ...
  <main id="top">
   ...
   <footer className="footer section"><div className="footer-mark">✦</div><h2>SEE YOU<br/><span>ON THE DANCE FLOOR.</span></h2><div className="footer-row"><div><b>GARBA GROOVE</b><small>by Street Cause</small></div><a href={PAYMENT_URL} target="_blank" rel="noreferrer">GET PASS <ArrowUpRight size={14}/></a></div><div className="footer-bottom"><span>© {EVENT.year} Street Cause</span><span>Made to move.</span></div></footer>
  </main>
 </div>
}
